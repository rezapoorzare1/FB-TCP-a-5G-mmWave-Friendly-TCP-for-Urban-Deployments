...
//3.6 The sixth tree.
        Ptr < Building > building6;
        building6 = Create<Building> ();
        building6->SetBoundaries (Box (11.5,12.0,
                                       67.0, 67.5,
                                       0.0, 10));



//3.7 The seventh tree.
        Ptr < Building > building7;
        building7 = Create<Building> ();
        building7->SetBoundaries (Box (13.5,14.0,
                                       67.0, 67.5,
                                       0.0, 10));
...
//3.8 The eighth tree.
        ...
        building8->SetBoundaries (Box (15.5,16.0,
                                       67.0, 67.5,
                                       0.0, 10));
...
//3.9 The ninth tree.
        ...
        building9->SetBoundaries (Box (17.5,18.0,
                                       67.0, 67.5,
                                       0.0, 10));
...
//3.10 The tenth tree.
        ...
        building10->SetBoundaries (Box (19.5,20.0,
                                       67.0, 67.5,
                                       0.0, 10));
...
Simulator::Schedule (Seconds (20), &ChangeSpeed, ueNodes.Get (0), Vector (0, 0, 0));
